...
### Added
- `content/post-554-video-tekhniky-samoocinka.md` — «Перший відеозапис тренування — протокол самооцінки техніки без тренера поруч»; Wulf & Prinz (2001) внутрішній vs зовнішній фокус уваги та чому внутрішнє відчуття є ненадійним джерелом; Kompf & Arandjelovic (2016) Sports Med — систематизація стікінг-поінтів як діагностика слабких ланок (анатомічних, нейральних, технічних); Wulf et al. (2010) European Journal of Sport Science — зовнішній фокус і моторна координація; кути зйомки по вправах (присідання / мертва тяга / жими / підтягування); чекліст що шукати і що ігнорувати (вираз обличчя, порівняння з YouTube, поодинока помилка); асиметрія: як читати і перший крок діагностики; протокол частоти (раз на тиждень-два), вибору підходу для запису, фіксації у журналі; зовнішнє переформулювання корекцій; коли відео є недостатнім інструментом; clinical-safety NOT REQUIRED; sports-scientist pending · ~13 хв читання

### Changed
- `blog.html` — додано картку post-554 (відеозапис тренування / самооцінка техніки); всього 460 карток
- `README.md` — roadmap: post-554 позначено [x] authored v4.4.0; Last update оновлено
- `VERSION` — 4.3.0 → 4.4.0
...
### Added
- `content/post-537-training-without-visible-results.md` — «Тренування без видимих результатів — 12 тижнів пройшли, нічого не змінилось»: Schoenfeld (2010) *JSCR* — двофазна хронологія адаптації (нейральна 1–6 тижнів, структурна 4–12+); Schoenfeld et al. (2017) *Journal of Sports Sciences* — середній темп гіпертрофії ~1–2% поперечного перерізу на місяць; Kraemer & Ratamess (2004) *MSSE* — варіативність відповіді досвідченого атлета (+5–10% 1RM за 12 тижнів є відмінним результатом); Zourdos et al. (2016) RIR 0–4 як зона ефективного стимулу; Nóbrega & Libardi (2016) тренування близько до відмови; Walker et al. (2020) сон <7 годин і силові показники; Dhabhar (2014) кортизол і mTORC1; три рівні діагностики: (1) прогресивне навантаження (тоннаж), (2) інтенсивність (RIR/RPE), (3) відновлення (сон, стрес); справжнє плато vs нормальний темп vs помилка вимірювання; протокол 4-тижневої перевірки. sports_scientist_review: APPROVED; clinical_safety: NOT REQUIRED.

### Changed
- `blog.html` — додана картка post-537 (448-а у індексі)
- `README.md` — post-537 відмічено як виконаний (v3.92.0); roadmap post-538–540 додано
- `STATUS.md` — 508 → 509 posts; blog.html v3.91.0 → v3.92.0; post-537 в TL;DR
- `VERSION` — 3.91.0 → 3.92.0
...
### Added
- `content/post-535-stale-lift-return-after-pause.md` — «Несвіже тренування — що відбувається, коли повертаєшся до знайомого підйому після 3–4 місяців паузи»: Seaborne et al. (2018) *Scientific Reports* — epigenetic muscle memory; епігенетичний профіль м'язів відновлюється швидше і досягає вищих показників при повторному тренуванні; Bruusgaard et al. (2010) *PNAS* — міонуклеарна стабільність при атрофії: ядра зберігаються довше за саркомери; Bickel et al. (2011) *MSSE* — силові адаптації при 1/9 об'єму; Sale (1992) нейральні адаптації до силового тренінгу; Mujika & Padilla (2001) детренування; RPE-парадокс при поверненні (нейральний патерн відновлюється першим — суб'єктивна легкість маскує структурне недовідновлення); тижневий алгоритм повернення (тиждень 1: 30–50% об'єму, 50–70% 1RM, RIR 4–6; тиждень 2: нормальне навантаження); RPE-рекалібрування як окремий процес (відносні тренди, не абсолютні значення). sports_scientist_review: APPROVED; clinical_safety: NOT REQUIRED.
- `content/post-536-when-does-a-block-end.md` — «Коли закінчується блок — практичні тригери завершення мезоциклу»: Haff & Triplett (2016) мезоцикл 3–6 мікроциклів — «8 тижнів» як практичний компроміс, не фізіологічна константа; Israetel, Feather & Crevens (2017) MRV-trigger — RPE-дрейф як суб'єктивний прояв наближення до MRV; Gabbett et al. (2016) *BJSM* — ACWR і ризик травм при пролонгованому блоці; Zourdos et al. (2016) RIR-шкала; три практичних тригери завершення: (1) RPE-дрейф — три тижні поспіль зростання RPE при стабільному навантаженні; (2) плато тижневого тоннажу — стагнація або зниження три з чотирьох тижнів; (3) провал 3RM/репетиційного максимуму — об'єктивне підтвердження накопиченої втоми; ціна продовження занадто довго (якість deload, ризик травм, мотиваційна деградація); ціна завершення занадто рано (втрата адаптаційного потенціалу); три питання для розрізнення сигналу від шуму (тренд чи епізод; зовнішнє пояснення; тест підтверджує?); поріг рішення: два з трьох тригерів, два тижні поспіль. sports_scientist_review: APPROVED; clinical_safety: NOT REQUIRED.

### Changed
- `README.md` — post-535 і post-536 відмічені як виконані (v3.91.0); roadmap post-537 залишається наступним
- `VERSION` — 3.90.1 → 3.91.0
...
### Added
- `content/post-533-chronic-lbp-training.md` — «Тренування і хронічний біль у спині — що можна, чого не можна, чого уникають дослідження»: жорсткий гейт для non-CNSLBP читачів; перелік червоних прапорців (радикулопатія, оніміння/слабкість у нозі, нетримання, нічний біль, тощо); огляд Hayden et al. Cochrane (2005, оновл. 2024) — рух ефективніший за відпочинок при CNSLBP; Foster et al. (2018, Lancet) — пасивна стратегія погіршує результати; чотири обмеження доказової бази (гетерогенна CNSLBP-популяція, нетренована когорта RCT, «зниження болю» ≠ «відновлення функції для тренінгу», протоколи без осьового навантаження); операціоналізовані сигнали зупинки підходу; критерії ескалації до лікаря (24h/48-72h/негайно); модифікації (техніка > об'єм, IAP per McGill 2002, прогресія без уникнення). clinical_safety: CONDITIONAL_PASS — усі 6 вимог виконані (hard gate, red flags, in-training stop signals, post-session escalation, no diagnosis language, closing referral). sports_scientist_review: APPROVED.

### Changed
- `VERSION` — 3.88.2 → 3.89.0
...
### Added
- `content/post-532-drop-sets-solo-mechanics.md` — «Дропсети без помічника — механіка і коли вони виправдані»: визначення і механічне розмежування (пін-дропсет / механічний дропсет / plate drop); механізм метаболічного стресу (Pi, H⁺, лактат) і розширене залучення високопорогових рухових одиниць; Angleri et al. (2017) *EJAP* 117(2):359–369 — дропсети не перевершують традиційний тренінг при рівному тоннажі; три виправдані сценарії застосування (часова ефективність, надбавка об'єму, відсутність партнера); протипоказання (великий об'єм, вправи зі штангою, початківці); механічна різниця vs. rest-pause; практичний протокол (підйоми гантелей + leg press). sports_scientist_review: APPROVED; clinical_safety: NOT REQUIRED.
- `blog.html` — картка post-532 додана
- `README.md` — post-532 ✓ (v3.88.0)
- `STATUS.md` — рядок post-532 у content engine table
...
### Added
- `content/post-530-forced-reps.md` — «Форсовані повторення: коли асистована відмова дає більше, а коли зменшує адаптацію»: Ahtiainen et al. (2003) EJAPh 21-тижневе порівняння RM vs форсовані повторення — гормони вищі, гіпертрофія ідентична; Drinkwater et al. (2007) JSCR елітні регбісти 0/2/4 форсованих — нульова різниця у 1ПМ; Sampson & Groeller (2016) SJMSS: відмова не є обов'язковою умовою гіпертрофії; Folland et al. (2002) BJSM: втома не є необхідним стимулом сили; West et al. (2012) JAP роз'єднаність гострої ендокринної відповіді і хронічної гіпертрофії; Schoenfeld (2010) JSCR механічна напруга і proximity-to-failure; Schoenfeld, Ogborn & Krieger (2017) JSCR тижневий обсяг як предиктор гіпертрофії; Burd et al. (2012) JPhysiol ексцентрична фаза і синтез протеїну; умови обґрунтованого застосування (досвідчений атлет, безпечна вправа, ексцентричний контроль, 1 підхід/тренування); умови де форсовані повторення знижують адаптацію (кожен підхід, початківці, нестабільний профіль безпеки); альтернативи rest-pause і дропсети; таблиця профілів атлетів. sports_scientist_review: APPROVED; clinical_safety: NOT REQUIRED.
- `blog.html` — додано картки post-528, post-529 і post-530
- `STATUS.md` — додано рядки post-528, post-529, post-530 у content engine table; Version 3.86.0; blog.html 441 cards / 530 posts authored
- `README.md` — roadmap: post-530 ✓ (v3.86.0)
...
### Added
- `content/post-525-resistance-bands-specificity.md` — «Резинові стрічки як інструмент, а не замінник штанги — де межа специфічності»: закон Гука і висхідна крива опору стрічок vs константне навантаження вільних ваг; Wallace et al. (2006) JSCR: зміщення пікової сили і швидкості при пружному опорі; Anderson et al. (2008) JSCR: акомодуючий опір (стрічки+штанга) +23 кг присідання за 7 тижнів; Ghigiarelli et al. (2009): покращення 1RM і вертикального стрибка; Joy et al. (2016) JSCR: рівна гіпертрофія, нижча максимальна сила; Frost et al. (2010) Eur J Appl Physiol: еластичний опір достатній у нетренованих; Loenneke et al. (2012) MSSE: BFR механізм; Cronin et al. (2003) JSCR: різні профілі м'язової активності; SAID-принцип і межі нейрального трансферу; матриця застосування (3 категорії). sports_scientist_review: APPROVED; clinical_safety: NOT REQUIRED.
- `blog.html` — додано картку post-525
- `README.md` — roadmap: post-525 позначено ✓ (v3.82.0)
- `STATUS.md` — додано рядки post-522/523/524/525 у content engine table; Version 3.82.0
...
### Added
- `compliance/cc1/personnel-security-policy.md` — POL-014 v1.0 IN_FORCE · Standalone auditor exhibit extracted from `docs/SOC2_READINESS.md §42`. Covers: background check policy (Checkr primary, Sterling fallback; GDPR Art. 6(1)(b) + Art. 10 legal basis; adjudication criteria; adverse result handling); NDA policy (10-clause template structure; DocuSign signing workflow; NDA register schema; four variant templates — employee, advisor, contractor rider, pentest MNDA); pre-boarding security checklist (11-step Day −14 → Day 30 timeline; production access gating on hire_check_passed DEC-030 event); four DEC-030 HMAC events (personnel.background_check_initiated STANDARD/7yr, personnel.background_check_passed HIGH/7yr, personnel.nda_signed STANDARD/7yr, personnel.hire_check_passed HIGH/7yr); SOC 2 CC1.1/CC1.4/CC6.1/CC6.3/P3.1 criteria mapping; seven evidence artefacts CC1-E-003a through CC1-E-007b. Closes CC1-GAP-003 🔴→🟡 (authored; closes to 🟢 on Checkr account + DPA + test check); PRE-04 🔴→🟡 (authored; closes to 🟢 on counsel review + first NDA signing). compliance-officer + security-engineer owners.
- `compliance/cc6/access-hardening-policy.md` — POL-015 v1.0 IN_FORCE · Standalone auditor exhibit extracted from `docs/SOC2_READINESS.md §43`. Covers: GitHub org MFA enforcement (CC6-GAP-001; TOTP required, SMS not accepted; pre-hire gate, not pre-launch gate; CC6-E-001a evidence path); Cloudflare account MFA enforcement (CC6-GAP-002; blast-radius narrative for Workers Secrets exposure; CC6-E-001b); tenant admin TOTP middleware (CC6-GAP-003; TypeScript `requireAdminMfa()` enforcement spec; 7-day grace period with DEC-030 waiver events; IdP delegation exemption with three-condition test; CC6-E-002); SCIM DELETE handler spec (CC6-GAP-004; atomic SQL + session invalidation + seat release + DEC-030 event; idempotent 204; last-owner 409 guard; CC6-E-003); npm audit CI gate (CC6-GAP-005; `--audit-level=critical`; dependabot.yml spec; exception bypass procedure; CC6-E-004); git-secrets pre-commit (CC6-GAP-006; six FORM-specific patterns; CI scan-history step YAML; CC6-E-005); CSP + ESLint P1 (CC6-GAP-007; full policy string; Cloudflare Transform Rule; no-eval/no-new-func/no-implied-eval rules; CC6-E-006). Six DEC-030 events registered. SOC 2 CC6.1/CC6.2/CC6.3/CC6.6/CC6.8 criteria mapping. Closes CC6-GAP-001 through CC6-GAP-007 to 🟡 AUTHORED. security-engineer + devops-lead + compliance-officer owners.
- `compliance/media-disposal/README.md` — C1-E-008 artifact description and schema reference. Covers: purpose (§40 policy extract; append-only log); full 12-column log schema per `docs/SOC2_READINESS.md §40.9`; artifact index (C1-E-008 active, cloud-disposal and backups sub-artifacts on first use); 7-year retention policy; DEC-030 `asset.device_disposal_logged` event payload. P0 pre-launch item from §40.13. compliance-officer owner.
- `compliance/media-disposal/device-disposal-log.csv` — C1-E-008 header row. Append-only log seeded with column headers per §40.9 schema (disposal_id, date, device_class, make_model, serial_number, asset_owner, reason, sanitization_method, certificate_ref, performed_by, witness, notes). Ready for first disposal entry. P0 pre-launch item from §40.13. compliance-officer owner.
- `compliance/offboarding/TEMPLATE-offboarding-checklist.md` — CC6-E-009 template. Three-phase checklist: Phase 1 (13-step access revocation SLA ≤24h: GitHub, 1Password, Cloudflare, Supabase, Sentry, PostHog EU, Better Stack, PagerDuty, Slack, Stripe, Anthropic, Linear, Google Workspace); Phase 2 (5-step device return SLA ≤7 business days: shipping label, receipt, NIST SP 800-88 sanitization, disposal log entry, DEC-030 event; BYOD attestation compensating control path); Phase 3 (completion sign-off, `personnel.offboarding_completed` DEC-030 event, access review update, filing). SOC 2 CC6.3/CC6.5/C1.2 criteria. P0 pre-hire item from §40.13. compliance-officer + security-engineer owners.
...
### Added
- `content/post-510-seasonal-programming-summer-winter.md` — «Сезонне програмування — чому тіло тренується по-різному влітку і взимку»: тепловий стрес і силова продуктивність (Simmons 1992, González-Alonso 1999), сезонне зміщення циркадного ритму (Zeitzer 2000), NHANES-дані про варіацію структурованої активності, дегідратація і mTOR-сигналізація (Judelson 2007, Häussinger 1993), мінімальний ефективний об'єм для підтримки (Bickel 2011), детренування (Mujika & Padilla 2000); сезонна модель тренувального року для самокерованих атлетів. 13 хв читання. clinical-safety NOT REQUIRED.
- `blog.html` — картка post-510, 437 карток загалом.
...
### Changed
- `content/post-506-adaptation-lag.md` — остаточна версія від sports-scientist (183 рядки): суперкомпенсація Stone et al., mTORC1/MPS Schoenfeld (2010), нейральна адаптація Kraemer & Ratamess (2004), подвійна фаза Coffey & Hawley (2007), мінімальні вікна оцінки сила 4–6/гіпертрофія 8–12/аеробна 8–10 тижнів, діагностика справжнього плато.
- `VERSION` — 3.70.2 → 3.70.3
...
### Changed
- `content/post-506-adaptation-lag.md` — фінальна редакція: структурна перебудова секцій, доповнення про сателітні клітини і ядерний домен, уточнення молекулярних основ адаптації.
- `content/post-507-cortisol-training.md` — фінальна редакція: детальніша механіка HPA осі (алостатичне навантаження, симпатоадреналова взаємодія), уточнення про гострий кортизольний відгук під час тренування, розширена секція про хронічний кортизол.
- `VERSION` — 3.70.1 → 3.70.2
...
### Changed
- `content/post-506-adaptation-lag.md` — розширена редакція: деталізація mTORC1 каскаду, сателітні клітини, нейральна vs структурна адаптація; +155 рядків, виправлено форматування абзаців.
- `content/post-507-cortisol-training.md` — розширена редакція: додаткові механізми HPA осі, покращена структура секцій; +40 рядків.
- `VERSION` — 3.70.0 → 3.70.1
...
### Added
- `content/post-507-cortisol-training.md` — «Тренування і кортизол — коли хронічний стрес зупиняє адаптацію (і коли ні)»; 12-хв читання; Kraemer & Ratamess (2005) MSSE гострий кортизольний відгук функціональний і необхідний; Schoenfeld (2010) JSCR транзиторне запалення як частина гіпертрофічного сигналу; хронічний кортизол → убіквітин-протеасомний катаболізм + пригнічення сателітних клітин + антагонізм IGF-1/тестостерону; Meeusen et al. (2013) EJSS консенсус OTS; Leproult & Van Cauter (2011) JAMA сон-кортизол цикл; Issurin (2010) функціональне vs нефункціональне перевантаження; HRV + ЧСС спокою як практичні маркери; editorial-brutalist; clinical-safety NOT REQUIRED. sports-scientist review pending.
- `blog.html` — картка post-507 додана (507 постів загалом).

### Changed
- `README.md` — post-507 marked [x].
...
### Added
- `content/post-501-program-vs-principles.md` — Програма чи принципи: ієрархія принципи→методологія→програма→сесія; Rhea et al. (2002) JSCR лінійна vs DUP — структура важливіша за модель; ACSM (2009) Position Stand структуроване vs неструктуроване; Haff & Triplett (2016) NSCA три рівні тренувального віку; Schoenfeld et al. (2019) MSSE об'єм як предиктор гіпертрофії проміжного рівня; Issurin (2010) Sports Med блокова прогресія і диференціація для просунутих; Ralston et al. (2017) Sports Med 8–16 тижнів для реалізації адаптації; Kiely (2012) IJSPP варіабельність відповіді і ліміти жорсткого планування; критерії виправданого відхилення vs уникнення важкого; program hopping як системний деструктор. clinical-safety NOT REQUIRED.

### Changed
- `blog.html` — 1 нова картка (post-501) → 426 карток (501 пост authored)
- `STATUS.md` — 500 → 501 постів; blog.html 425 → 426 карток; v3.64.0 → v3.65.0; content table: post-501 додано
- `VERSION` — 3.64.0 → 3.65.0
...
### Added
- `content/post-499-chronic-fatigue-vs-detraining.md` — Хронічна перевтома vs детренованість: Meeusen et al. (2013) ECSS/ACSM консенсус FOR→NFOR→OTS і відсутність єдиного біомаркера; психомоторна швидкість як клінічний маркер NFOR; Mujika & Padilla (2000a/b) — VO2max/плазмовий об'єм протягом 10–14 днів, максимальна сила стабільна 2–4 тижні, міоядра і моторні патерни — найдовше адаптації; «тренуюсь із дефіцитом» як норма, не патологія; дерево рішень за тижневими порогами (<2, 2–4, 4+ тижнів); зворотньо-тренувальний протокол 50–70% від попереднього навантаження. clinical-safety NOT REQUIRED.
- `content/post-500-connective-tissue-loading.md` — Сполучна тканина не встигає за м'язами: ієрархія адаптації м'язи(тижні)/сухожилля(місяці)/кістки(роки); Phillips et al. (1997) AJP м'язовий протеїн; Magnusson et al. (2010) колагеновий оборот сухожилля; Kjaer et al. (2004/2006) жорсткість і позаклітинний матрикс; Cook & Purdam (2009) BJSM клінічна модель (без прогностичних тверджень); Gabbett (2016) BJSM 5% тижневий ліміт; Frost (2003) кісткова механостатика; Helms et al. (2017) SCJ деантаж кожні 4–8 тижнів; маркери перевантаження без нормалізації симптомів, referral до фізіотерапевта в тексті. clinical-safety APPROVED WITH EDITS.

### Changed
- `blog.html` — 2 нові картки (post-499, post-500) → 425 карток (500 постів authored)
- `README.md` — roadmap: posts 499–500 ✓; нові теми 501–503 додані до flat list
- `STATUS.md` — 498 → 500 постів; blog.html 423 → 425 карток; v3.63.1 → v3.64.0; content table: posts 499–500 додано
- `VERSION` — 3.63.1 → 3.64.0
...
### Added
- `content/post-498-training-after-30.md` — Тренування після 30: Harman et al. (2001) JCEM тестостерон −1%/рік — незначний ефект у 30–39; Kraemer & Ratamess (2005) Sports Med андрогенні рецептори і тренування; Stupka et al. (2000) J Appl Physiol маркери пошкодження і відновлення; Enoka & Duchateau (2008) нейром'язова втома; Magnusson et al. (2008) колагенова мережа і сухожилля; Kongsgaard et al. (2010) синтез колагену і адаптація сухожилля; Wilkinson et al. (2015) анаболічна резистентність після 65 (не після 35); Farina et al. (2014) Nat Rev Neurosci моторна система і вік; Peterson et al. (2011) MSSE мета-аналіз силового тренінгу 35–50; Juster et al. (2010) алостатичне навантаження і загальний стрес; три програмувальних модифікації: сухожилля-перший, калібрування відновлення, рахунок загального стресу. clinical-safety NOT REQUIRED.

### Changed
- `blog.html` — нова картка post-498 → 423 картки (498 постів authored)
- `README.md` — roadmap: post-498 ✓ (виконано); нові теми 499–503 додані до roadmap
- `STATUS.md` — 497 → 498 постів; blog.html 422 → 423 картки; v3.62.0 → v3.63.0; content engine table: post-498 додано
...
### Added
- `content/post-493-tempo-training-vs-load.md` — Темп повторення проти навантаження: Burd et al. (2012) J Physiol TUT і MPS — SLOW (6-0-6 @ 30% 1RM) vs NORMAL (80%) vs FAST (30%) до відмови; Wilk et al. (2020) JSCR 8-тижнева RCT 2-0-2 vs 6-0-2 @ 60% 1RM; Wilk et al. (2021) IJEPH ефект темпу зникає при 80% 1RM; Schoenfeld & Grgic (2020) мета-аналіз TUT і гіпертрофії; Mitchell et al. (2012) JAP навантаження (80% vs 30% 1RM × 1/3 підходи до відмови); механіка редукції навантаження при повільному темпі (рекрутинг МВ I/II, пікове зусилля, псевдостомленість); контексти де темп реально допомагає (технічне навчання, реабілітація, ізоляція); практична матриця вибору темпу. clinical-safety NOT REQUIRED.

### Changed
- `blog.html` — 1 нова картка (post-493) → 421 карток (493 пости authored)
- `README.md` — roadmap: post-493 → [x] з реальними описами; нова секція post-494+ (4 теми: прогресивне навантаження, тренування натще, cooldown, ізометрія)
- `STATUS.md` — content engine: 492 → 493 постів; blog.html 420 → 421 карток; post-493 у файловому реєстрі; версія 3.60.0 → 3.61.0
...
### Changed
- `content/post-452-exercise-selection-individual-anatomy.md` — розширена редакція: більш конкретне відкриття (3 місяці роботи без змін → анатомія), окремий §§ для ацетабулярної орієнтації (Pollard et al. 2010), точніше прочитання Schoenfeld (2010), діагностичне правило 6–8 тижнів, 5-крокова практична перевірка. Bobroff (1999), Hales (2009), Kapandji (2011) додані до *Джерела*. Кількість слів: +128 рядків.
- `VERSION` — 3.47.0 → 3.47.1.
...
### Added
- [`content/post-451-training-while-traveling.md`](content/post-451-training-while-traveling.md) — Тренування у подорожі: Issurin (2008/2010) residual training effects — max сила ~30 днів, нейром'язова ефективність ~10–20 днів; Bickel et al. (2011) 1/9 об'єму зберігає гіпертрофічні адаптації 32 тижні; Graves et al. (1988) 12 тижнів детренованості = −10–15% сили; Mujika & Padilla (2001) VO₂max детренованість 2–4 тижні; Gabbett (2016) ACWR стрибок навантаження >15%/тиждень підвищує ризик травми; ієрархія детренованості (нейром'язова → кардіо → сила → гіпертрофія); математика 7-денного пропуску; мінімальний 30-хвилинний протокол без обладнання (болгарський випад, ягідний міст, віджимання, піке-пушап, кор); протокол повернення першого тижня — 80% об'єму, RIR +1–2; анатомія помилки «надолужити». clinical-safety NOT REQUIRED.
- `blog.html` — додано 3 картки: post-449 (Психологія зупинки підходу), post-450 (Силовий тренінг і імунна система), post-451 (Тренування у подорожі); загальна кількість карток 392.
- `README.md` — post-451 позначено [x]; додано roadmap post-452–455 (анатомічний вибір вправ, самостійна технічна діагностика, dual-goal програмування, сон як адаптаційний процес).

### Changed
- `VERSION` — 3.45.2 → 3.46.0.
- `STATUS.md` — версія 3.46.0, дата 11 червня 2026, 451 постів, blog.html 392 картки.
...
### Added
- [`content/post-448-signal-noise-training-progress.md`](content/post-448-signal-noise-training-progress.md) — Шум і сигнал у тренувальному прогресі: Sale (1988) варіабельність сили ±5–10% день-до-дня як фізіологічна норма; Killen et al. (2022) фрагментація сну і відтворюваність підходів; Facer-Childs et al. (2018) циркадіанні ефекти ±3–8%; Schoenfeld et al. (2017) мета-аналіз — гіпертрофічний сигнал потребує 8–12 тижнів для надійного виявлення; Kivlan et al. (2013) сухожилля 10–24+ тижні; ієрархія трьох рівнів адаптації (нейром'язова 2–4 тижні / гіпертрофія 8–16 / сполучна тканина 12–36); recency bias і loss aversion як механізми хибного зчитування сигналу; 3-тижневий ковзний огляд як операційний інструмент; матриця "шум vs. сигнал vs. плато vs. накопичена втома"; когда зміна програми виправдана і коли ні; мінімальний 4-змінний протокол запису (навантаження / повторення / RPE / умови). clinical-safety NOT REQUIRED.

### Changed
- `VERSION` — 3.44.4 → 3.44.5.
- `STATUS.md` — TL;DR: 444 → 445 posts; blog.html рядок: 388 → 389 карток; content engine table: новий рядок post-448.
- `blog.html` — додана картка post-448.
...
### Added
- [`content/post-436-prilepin-chart-volume-intensity.md`](content/post-436-prilepin-chart-volume-intensity.md) — Таблиця Пріліпіна: радянська математика інтенсивності та об'єму, яку досі недооцінюють (13 хв). Stone, O'Bryant & Garhammer (1981) перший англомовний синтез методики Пріліпіна; оригінальні дані 1974 р. — аналіз тренувальних журналів радянських важкоатлетів вищого рівня; таблиця чотирьох зон (55–65%, 70–75%, 80–85%, 90%+) з оптимальним і допустимим сумарним об'ємом за сесію; механізм нейральної втоми і деградації якості повторення; Hatfield (1989) адаптація для широкого силового тренування; Wendler 5/3/1 як практичне втілення; Israetel et al. (2015) MEV/MAV/MRV як сучасне розширення; Morton et al. (2016) і Schoenfeld et al. (2017) proximity to failure — критика відсутності RIR-виміру у Пріліпіна; поправки +20–30% для технічно простіших рухів (присідання/жим/тяга); практичний приклад тижневої 3-денної структури; де таблиця ламається (вибірка важкої атлетики, відсутність тренувального-вікового урахування, сесійний а не тижневий зріз). clinical-safety NOT REQUIRED.

### Changed
- `blog.html` — додано картку post-436; лічильники: 379→380 статей, 4 319→4 332 хвилин читання.
- `README.md` — roadmap: [x] post-436 з темою і джерелами; додано 3 нові теми у roadmap (post-437–439).
- `STATUS.md` — TL;DR: 435→436 постів; blog.html row: 379→380 карток; content engine: +1 новий рядок.
- `VERSION` — 3.41.3 → 3.41.4.
...
### Changed
- [`docs/OBSERVABILITY.md §33`](docs/OBSERVABILITY.md) — Enterprise Tenant Engagement Health & QBR Metrics Observability. §33 closes the gap between infrastructure SLOs (§7.4 Per-Tenant SLA, §13 tenant_id propagation) and behavioral engagement signals required for CSM-led churn prevention and QBR delivery. §33.1 scope: three-row comparison table distinguishing §33 (behavioral, CSM-facing, internal) from §7.4 (infra, tenant-admin-facing, external) and §13 (technical propagation); three non-negotiable privacy invariants (aggregate-only, k-anonymity n ≥ 10, HR-never-sees-individual). §33.2 twelve-metric engagement taxonomy: `provisioned_seats`, `active_seats_wau`, `seat_utilization_7d`, `coaching_sessions_30d` (session_id count only — no content), `coaching_sessions_per_active_seat`, `onboarding_completion_rate`, `cohort_retention_30d`, four binary `feature_adoption_*` flags (SSO/SCIM/admin-login/wearable), `chs_score`, `chs_band`; `form_analytics` role column-level privilege enforces zero access to PII and content columns. §33.3 Customer Health Score (CHS) model: four-component weighted score (seat utilization 40%, coaching engagement 30%, onboarding/retention 20%, feature adoption 10%); five scoring bands per component; three CHS bands (healthy ≥ 70, at_risk 40–69, critical < 40); k-anonymity gate suppresses CHS for tenants < 10 provisioned seats. §33.4 six AL-ENGAGE-* alert rules: AL-ENGAGE-01 (P2 Slack, util < 40% for 14d), AL-ENGAGE-02 (P1 PagerDuty, util < 25% for 7d, 7d re-alert), AL-ENGAGE-03 (P1 PagerDuty, zero coaching sessions with ≥ 5 active seats), AL-ENGAGE-04 (P2, new tenant onboarding < 50% at Day 30), AL-ENGAGE-05 (P2, CHS newly critical), AL-ENGAGE-06 (P1, CHS < 30 freefall 3 consecutive weeks, CS VP escalation); no individual user data in any alert payload. §33.5 six-row §6.2 `engagement_health` subsection. §33.6 QBR package: eight approved metrics; explicit prohibition list (no individual data, no CHS score, no tenant comparison, no health data); `tenant_qbr_report_generate` Edge Function + `tenant.qbr_report_generated` DEC-030 event; quarterly compliance-officer spot-check. §33.7 `tenant_engagement_snapshots` DDL (migration 0057): sixteen columns + `below_k_threshold` boolean; UNIQUE (tenant_id, snapshot_date); four RLS policies (form_analytics INSERT-only, form_system full, customer_success SELECT where below_k_threshold=false, zero tenant_admin policy — HR invariant at DDL level); 36-month rolling cleanup. §33.8 pg_cron jobs 18 (`tenant_engagement_daily`, 02:00 UTC) and 19 (`tenant_chs_compute`, 02:30 UTC); job numbers 16–17 reserved by DATA_MODEL.md §28; full SQL provided for both jobs. §33.9 seven privacy constraints with enforcement point and CI test assertion. §33.10 four DEC-030 events: `tenant.churn_risk_flagged` (HIGH 3yr), `tenant.engagement_milestone_achieved` (STANDARD 90d), `tenant.qbr_report_generated` (STANDARD 90d), `analytics.tenant_engagement_computed` (LOW 30d); Zod schema for churn_risk_flagged provided. §33.11 SOC 2 mapping: C1.1/C1.2/CC2.2/CC7.2/A1.1; three evidence artefacts ENGAGE-E-001 through ENGAGE-E-003. §33.12 implementation checklist: 6× P0 M13 (migration 0057, jobs 18+19, AL-ENGAGE-02/03 PagerDuty, DEC-030 registration), 7× P1 M13–M14 (Slack alerts, AL-ENGAGE-06 PagerDuty, Metabase dashboard, QBR Edge Function, evidence collection, §6.2 update, SOC2_READINESS cross-ref), 3× P2 M16+ (CHS weight calibration, cohort_retention_30d computation, OQ-ENGAGE-03). §33.13 three open questions: OQ-ENGAGE-01 (seat utilization widget for tenant admins in Admin Dashboard — P1 M16), OQ-ENGAGE-02 (k-anonymity adequacy for 1,000+ seat tenants — P2), OQ-ENGAGE-03 (CHS weight calibration vs churn correlation — P2 after 5 renewals). Header bumped v2.3 → v2.4.
- `VERSION` — 3.41.1 → 3.41.2.
...
### Added
- [`content/post-429-isolation-exercise-progression.md`](content/post-429-isolation-exercise-progression.md) — Прогресія у ізоляційних вправах: чому вона повільніша — і коли plateau нормальний (13 хв). Moritani & deVries (1979) нейральна адаптація домінує у базових рухах; математика відносного приросту (2,5 кг у ізоляції = +21%, у базовому = +3%); Lasevicius et al. (2019) 7–11% гіпертрофії двоголового за 8 тижнів — реальний темп; Wolf et al. (2023) lengthened position і ексцентр; специфіка прогресії різних м'язових груп; п'ять альтернативних векторів прогресії (RPE-anchor, діапазон, темп ексцентра, щільність, варіант вправи); матриця «нормальний plateau vs реальна проблема». clinical-safety NOT REQUIRED.
- `blog.html` — нова картка post-429; лічильники оновлено 375→376 статей, 4 264→4 277 хв читання

### Changed
- `README.md` — post-429 відмічено ✓ у roadmap `#### Roadmap post-364+`
- `STATUS.md` — оновлено до 429 постів, 376 карток, v3.40.1
...
### Added
- [`content/post-424-effective-sets-stimulating-reps.md`](content/post-424-effective-sets-stimulating-reps.md) — Ефективні підходи: скільки з ваших сетів реально дають гіпертрофічний стимул (14 хв). Morton et al. (2016) low vs high load equated for failure → зіставна гіпертрофія незалежно від навантаження; принцип Henneman і рекрутування швидких рухових одиниць у фінальних повторах; концепція stimulating reps — ~5 останніх повторень перед відмовою несуть основний гіпертрофічний сигнал; RIR-таблиця кількості ефективних повторень на сет; Krieger (2010) мета-аналіз обсяг-гіпертрофія; Amirthalingam et al. (2017) 5 vs 10 сетів і спадна маргінальна віддача; junk volume як функція RPE; практичний аудит програми. clinical-safety NOT REQUIRED.
- `blog.html` — нова картка post-424; лічильники оновлено 362→371 статей, 4 084→4 208 хв читання (включно з posts 416–423 і post-424)
- `README.md` — posts 416–423 відмічено ✓ у roadmap `#### Roadmap post-364+`; post-424 ✓; додано теми post-425..428
- `STATUS.md` — оновлено до 424 постів, 371 карток, v3.39.2; рядки таблиці для posts 416–424
...
### Added
- `content/post-396-hormonal-cycle-training-evidence.md` — Тренінг і менструальний цикл: McNulty et al. (2020) SJMSS мета-аналіз (d = 0.15, фолікулярна > лютеальна, I² = 67%), Wikström-Frisén (2017) RCT цикл-базованого програмування, Ansdell et al. (2020) стійкість до стомлення, ACL-ризик (Wojtys 1998, Hewett 2007), гормональна контрацепція (Elliott-Sale 2020), індивідуальна варіативність як домінантний фактор, трекінг-протокол; клінічно-безпечний фрейм: продуктивнісний, рефер при нерегулярному циклі вбудований; clinical-safety PASS (~2,600 words, UA)
- `blog.html` — +5 карток (post-392–395 раніше відсутні + post-396), лічильник 332 → 337 карток

### Changed
- `VERSION` → 3.29.0 (MINOR: post-396 + backfill blog.html cards 392–395)
...
### Added
- `content/post-385-efficiency-vs-effectiveness-training-volume.md` — Ефективність vs ефектність: чому той самий результат досягається з меншим об'ємом; Krieger (2010, JSCR): метааналіз одно-/дво-/трисетових протоколів — спадна гранична дохідність: +40% гіпертрофії при переході 1→2–3 підходів, лише +17% при 2–3→4–6 при +50–100% об'єму; Schoenfeld, Ogborn & Krieger (2017, JSCR): три категорії об'єму — дані не підтримують лінійну залежність «більше = завжди краще» для верхнього діапазону; Ralston et al. (2017, Sports Medicine): кореляція об'єм-сила слабшає за межами 4–8 підходів/вправа/тиждень для тренованих атлетів; McLester, Bishop & Guilliams (2003): 1-денний vs 3-денний розподіл при рівному тижневому об'ємі — рівні ефекти на силу і гіпертрофію; Baz-Valle et al. (2022, IJERPH): варіативність вправ не дає додаткової гіпертрофії при рівному об'ємі; McEwen & Stellar (1993, AIM): алостатичне навантаження — організм веде єдиний рахунок для всіх стресорів; Meeusen et al. (2013, ECSS/ACSM): non-functional overreaching настає при нижчому об'ємі за підвищеного загального стресу; Shimizu et al. (2011): хронічно підвищений кортизол пригнічує mTORC1 і знижує MPS-відповідь; Raastad et al. (2003): скорочення об'єму при збереженні інтенсивності зберігає адаптацію; практичний протокол: 8–12 підходів/м'яз/тиждень старт, RPE 7–9 фільтр якості, прогрес — мірило ефективності; 5-кроковий алгоритм коригування об'єму; 13 хв читання; clinical-safety NOT REQUIRED

### Changed
- `blog.html` — додано картку post-385 (385 карток, 385 постів)
- `README.md` — post-384 позначено ✓, post-385 позначено ✓, додано roadmap post-391–395
- `STATUS.md` — додано рядок post-385, оновлено лічильник до 385 постів
...
### Added
- `content/post-384-external-focus-attention-strength-training.md` — Зовнішній фокус уваги і силовий тренінг: чому «штовхай підлогу» працює краще за «напружуй квадрицепс»; Wulf, Höß & Prinz (1998, RQES): перше систематичне порівняння — зовнішній фокус перевершує внутрішній в точності, ефективності і швидкості навчання; Marchant, Greig & Scott (2009, JSS 27(1), 107–115): зовнішній фокус → достовірно вищий пік силового виходу в силових завданнях; Porter, Wu & Partridge (2010, JSCR): зовнішній фокус перевершує внутрішній у поштовху ядра і вертикальному стрибку у досвідчених спортсменів; Wulf (2013, Kinesiology Review): систематичний огляд трьох десятиліть — ефект відтворюється незалежно від стажу і культури; Wulf & Lewthwaite (2016, PBR): OPTIMAL-теорія — гіпотеза обмеженої дії (constrained action hypothesis); бібліотека підказок для 6 основних вправ (присідання, становая тяга, жим лежачи, жим стоячи, підтягування, горизонтальна тяга); три поширені помилки самотренуючих атлетів; контексти де внутрішній фокус виправданий (початкове навчання, корекція між підходами, реабілітація); практичний 5-крокового алгоритм впровадження; 12 хв читання; clinical-safety NOT REQUIRED

### Changed
- `blog.html` — додано картку post-384 (384 карток, 384 постів)
...
### Changed
- `docs/COST_MODEL.md` — §31 Pricing Architecture, Competitive Benchmarking & Discount Governance: closes the gap between FORM's published price list and its documented derivation rationale. §31.2 consumer Pro $19/month derivation: WTP anchor table against human PT ($200–$600), AI coaching (Future/Caliber $149–$199), mid-tier apps (Fitbod $15, Ladder $20); COGS coverage at $19 (96.9% GM SBP / 96.2% standard 30%); price sensitivity range $12–$39; consumer floor $12. §31.3 enterprise tier derivation: three-input methodology (COGS floor + target GM, competitive WTP ceiling, value anchor vs. consumer); Starter $12 fully-loaded GM 83.3% (email CSM $1.67/seat); Growth $9 fully-loaded GM 85.1% (named CSM $1.00/seat at 300-seat avg); Enterprise $6–8 midpoint $7 fully-loaded GM 88.0%; ACV floor table (Starter 50 seats = $7,200/year, Growth 201 seats = $21,708, Enterprise 1,001 = $84,084); OQ-11 resolution — 50-seat Starter floor defensible at 73.5% Year 1 GM. §31.4 corporate wellness competitive benchmarking: eight platforms — Wellhub/Gympass ($8–$45 gym network), Headspace for Work ($10–$14), Calm for Business ($10–$15), Virgin Pulse/Personify Health ($40–$75 incentive platform), Noom for Work ($30–$50; FORM cannot compete here by ethics), Peloton Corporate ($20–$40), Whoop for Teams ($18–$30), Future enterprise ($99–$149); positioning conclusion: FORM occupies unique $6–12 AI coaching quadrant; gym stipend substitution framing ($600–$1,800/year → $72–$144/year); four-point anchor script for sales conversations. §31.5 COGS-anchored price floors: theoretical (Starter $3.00, Growth $2.00, Enterprise $1.50); contractual floors at 50% of list (Starter $6.00, Growth $4.50, Enterprise $4.00). §31.6 discount authority matrix: pre-approved schedule max –32.5% (3yr + upfront, multiplicative); non-standard up to –40% requires founder; up to –50%/floor requires founder + investor pre-Series A; below floor NOT PERMITTED at any approval level. §31.7 pricing change governance: consumer 30-day notice + annual grandfathering; enterprise 90-day notice at renewal; annual price indexation CPI+1% capped 5% (MSA clause); rate lock for contracted term; four underprice signals vs. four overprice signals. §31.8 four DEC-030 pricing audit events: `enterprise.pricing_exception_approved` (HIGH, 7yr), `enterprise.consumer_price_updated` (HIGH, 7yr), `enterprise.list_price_updated` (HIGH, 7yr), `enterprise.price_floor_override_requested` (CRITICAL, 7yr). §31.9 eight-item checklist: P0/M4 (DEC-030 event registration + calculator floor enforcement + exception procedure), P1/M5–M6 (MSA escalation clause + quarterly competitive intelligence + COMPETITIVE.md enterprise section), P2/M9–M12 (WTP validation study + annual pricing review). §31.10 three open questions: OQ-PRICE-01 (non-profit/edu discount tier — defer until three commercial deals close), OQ-PRICE-02 (consumer $19 price review trigger conditions — D90 ≥ 40% + NPS ≥ 60 + ARR ≥ $200k), OQ-PRICE-03 (CV-optional enterprise pricing — single-price model for now; "Professional" SKU at $8/seat if CV-restriction objection > 3 deals)
