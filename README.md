...
- [ ] post-130: М'язово-сухожильна жорсткість і еластичне збереження енергії — compliance vs stiffness у performance; роль ахілового сухожилля як пружного резервуара; як тренувати жорсткість (важкі ізометрії, ударне навантаження, plyometrics); відмінності між м'язовою і сухожильною жорсткістю
- [ ] post-131: Циркадна біологія і тренувальний тайминг — хронотип, добова варіація сили ~3–8% (Atkinson & Reilly 2007); циркадна генна експресія у м'язах; Clock-генова регуляція мітохондрій і синтезу білка; практика: коли тренуватись за хронотипом
- [ ] post-132: Спінальні рефлекторні ланцюги і гальмування — сухожильний орган Гольджі (GTO) і Ia-інгібіторні інтернейрони; реципрокне гальмування; H-рефлекс і його адаптація до тренінгу; чому «розслаблення антагоністів» є нейральним навиком
- [ ] post-133: Сигнальний каскад mTORC1 — Akt/S6K1/4E-BP1 при механічному і метаболічному стимулі; leucine як upstream сенсор (Castellano et al.); AMPK як антагоніст mTOR при тривалому кардіо; практичні наслідки тайминга і пріоритетів тренування
