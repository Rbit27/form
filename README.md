...
- [ ] post-330: Прогресія у мобільності для силовика — де обмеження реально стоїть (капсула, нейральне гальмування vs пасивна жорсткість), протокол PNF vs статичний стретчинг після силового тренінгу, як інтегрувати без окремої «мобілайті-сесії»; clinical-safety NOT REQUIRED
- [ ] post-331: Тренінг після хвороби — як повернутися без регресу; правило 7-10 днів, RPE-керований comeback, чого не робити в перший тиждень; clinical-safety NOT REQUIRED
- [ ] post-332: Програмування для двох цілей одночасно — сила і гіпертрофія без компромісу; де вони доповнюють, де конфліктують, матриця рішень по тренажерному стажу; clinical-safety NOT REQUIRED
