...
- [x] post-145: Механотрансдукція і tensegrity — integrin–costamere–cytoskeleton–LINC complex–nuclear lamina ланцюг; Piezo1/2 механочутливі канали (Coste et al. 2010 Science, Нобель 2021); focal adhesion kinase (FAK) і ранній сигнальний відгук (Flück et al. 2008); tensegrity (Ingber 2003); phosphatidic acid через PLD (Hornberger et al. 2006 PNAS); чотири паралельних механотрансдукційних шляхи до mTORC1 і синтезу білка; clinical-safety NOT REQUIRED
- [ ] post-146: Heat shock proteins і м'язова адаптація — HSP70/HSP27/HSP90 як молекулярні шаперони; гостра vs хронічна індукція HSP тренінгом; Kregel (2002) огляд HSP і теплового стресу; роль у захисті міофібрилярних білків під час ексцентричного навантаження; HSP і exercise-induced muscle damage (EIMD); клінічне значення для periodization і інтенсивності навантаження; clinical-safety NOT REQUIRED
- [ ] post-147: Епігенетика і м'язова пам'ять — метилювання ДНК і гістонова ацетиляція при тренінгу; Seaborne et al. (2018 Sci Rep) — демонстрація гіпометилювання IGF1/MGF/MSTN після тренінгу і відновлення гіпертрофічної відповіді після деренування (muscle memory); HDAC/HAT баланс; MRF-асоційована епігенетична регуляція; практичні наслідки для повернення після паузи; clinical-safety NOT REQUIRED
- [ ] post-148: Субстратна утилізація при силовому тренінгу — PCr система (~10 с); гліколіз і накопичення лактату; лактат як паливо (lactate shuttle, Brooks 2002), не продукт втоми; IMTG і ліпідна оксидація при низькоінтенсивних сетах; метаболічна гнучкість і тренувальна адаптація; чому «закислення» — не причина відмови; clinical-safety NOT REQUIRED
- [ ] post-149: Нейром'язовий синапс і адаптація — агрин-MuSK-рапсин ланцюг і кластеризація AChR; AChR turnover і structural plasticity NMJ; Morris et al. (2017) — silencing моторних нейронів знижує постсинаптичну щільність; NMJ морфологія у силових атлетів vs. sedentary (розширення, підвищення складчастості); вплив деренування на NMJ; clinical-safety NOT REQUIRED
