...
- [ ] post-437: Криві сили і вибір вправ — чому штанга і гантель дають різний стимул у різних точках ROM; force-curve matching; Behm & Sale (1993) кутова специфічність; Cameron & Adams (1994) resistance profile; практична матриця вправ за типом кривої (ascending/descending/bell-shaped); коли кабельний тренажер перевершує вільні ваги
- [ ] post-438: Подвійна прогресія — систематичний підхід до просування між вагами без перестрибування; алгоритм «репи → вага → репи»; чому відсоткові схеми погано описують реальний тренувальний процес проміжного атлета; Zourdos et al. (2016) RIR-заземлення прогресії; практичний щоденник прогресії
- [ ] post-439: Силові стандарти і самооцінка прогресу — методологія порівняння без змагальних орієнтирів; алометричне масштабування Stone et al. (1991); Wilks і IPF GL коефіцієнти; три питання самооцінки для self-coached атлета; коли стандарти корисні і коли є пасткою
