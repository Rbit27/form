...
- [ ] post-251: Концентричне vs ексцентричне vs ізометричне стомлення — різні профілі втоми і їх наслідки для програмування тижня; Howell et al. (1995): preferential damage in eccentric; Pasquet et al. (2000 Eur J Appl Physiol): ізометрична втома і відновлення; нейронні механізми кожного типу; практична матриця: ексцентричне акцентовані вправи — куди у тижні; clinical-safety NOT REQUIRED
- [ ] post-252: Перехідний блок між мезоциклами — що відбувається у тижні між програмами; суперкомпенсація vs детренінг у перехідний тиждень; як знижувати навантаження без втрати нейронного тонусу; Bosquet et al. (2007 Med Sci Sports Exerc): tapering мета-аналіз; практика «накопичувального потенціалу» у перехідному блоці; clinical-safety NOT REQUIRED
- [ ] post-253: Доза-відповідь у силовому тренінгу — крива Krieger (2010 J Strength Cond Res): 1 vs 2–3 vs 4+ сети; Ralston et al. (2017 J Strength Cond Res) мета-аналіз об'єм-сила; Schoenfeld et al. (2017 J Strength Cond Res): volume-hypertrophy dose-response; diminishing returns і де вони на практиці; MRV як концепт і як орієнтир; clinical-safety NOT REQUIRED
- [ ] post-254: Вибухова сила і гіпертрофія — чи сумісні? Frost et al. (2016 J Strength Cond Res): ballistic vs slow-tempo hypertrophy; Newton et al. (1996): motor unit recruitment ballistic vs controlled; RFD-training і м'язова архітектура; програмування plyometrics у гіпертрофійному блоці; clinical-safety NOT REQUIRED — Damas et al. (2015 J Physiol): MPS повертається до базового через 60–72 год у тренованих атлетів; Schoenfeld, Ogborn & Krieger (2016 J Strength Cond Res мета-аналіз): 2×/тиждень > 1×; Dankel et al. (2017 Eur J Appl Physiol): частота vs обсяг — переплетення, ефект частоти зникає при контролі обсягу; McLester et al. (2000 J Strength Cond Res): рівний обсяг при 1× vs 3×; Colquhoun et al. (2018 J Strength Cond Res): 6× vs 3×/тиждень при рівному обсязі — без різниці; частота як інструмент розподілу якісного тижневого обсягу, не самостійна адаптаційна змінна; clinical-safety NOT REQUIRED
