...
- [ ] post-254: Вибухова сила і гіпертрофія — чи сумісні? Frost et al. (2016 J Strength Cond Res): ballistic vs slow-tempo hypertrophy; Newton et al. (1996): motor unit recruitment ballistic vs controlled; RFD-training і м'язова архітектура; програмування plyometrics у гіпертрофійному блоці; clinical-safety NOT REQUIRED
- [ ] post-255: Ментальна втома і фізична продуктивність — Marcora et al. (2009 J Appl Physiol): когнітивне завдання до виснаження → -15% витривалості при тому ж RPE; центральна теорія стомленості vs периферійний механізм; Pageaux & Lepers (2018): нейромеханізми ментальної втоми і м'язова сила; ранкове vs вечірнє тренування при когнітивно навантаженому дні; наслідки для часу і структури тренування; clinical-safety NOT REQUIRED
- [ ] post-256: Перенесення сили між вправами — SAID principle і межі специфічності; Abernethy & Jurimäe (1996 Eur J Appl Physiol): cross-specificity in strength training; Seitz et al. (2014): transfer of training in strength; чи переноситься присідання на тягу і навпаки; практика допоміжних вправ: що реально допомагає основному ліфту; clinical-safety NOT REQUIRED
- [ ] post-257: Тренінг у спеку — теплова акліматизація і адаптація; Périard et al. (2021 Sports Med) систематичний огляд протоколів теплової акліматизації; розширення плазмового об'єму як адаптація; практика тренінгу у залі без кондиціонера влітку; відмінність від post-102 (теплова продуктивність); clinical-safety NOT REQUIRED
