...
- [ ] post-461: Тренування з партнером vs соло — social facilitation (Zajonc 1965), кількісна різниця об'єму, ефект присутності на RPE; коли партнер гальмує прогрес; рекомендації для самокоучингу
