...
- [ ] post-171: Сон і спортивні результати — не «більше сну», а «правильний сон» — Walker et al. (2002 Neuron): sleep для моторного навчання; Mah et al. (2011 Sleep): розширення сну у баскетболістів (+9% швидкість, −0.7 с реакція); SWS і GH-пульс; REM і когнітивна підготовка; практичний sleep hygiene без мотиваційного тексту; clinical-safety PASS
