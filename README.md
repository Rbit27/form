...
- [ ] post-433: Навантаження на суглоби — як силовий тренінг впливає на суглобовий хрящ, зв'язки та меніски (без клінічних рекомендацій); Eckstein et al. (2006) хрящ і навантаження; Warden et al. bone/tendon loading; clinical-safety NOT REQUIRED
- [ ] post-434: Мотивація vs дисципліна у силовому тренуванні — де нейронаука, де маркетинг; self-determination theory (Deci & Ryan); implementation intentions; volitional components; чому «мотиваційний» підхід системно ненадійний; clinical-safety NOT REQUIRED
- [ ] post-435: Контрастний метод і PAP-комплекси для рекреаційних атлетів — тяжкий підхід → вибухова вправа; фізіологічний механізм (phosphorylation myosin regulatory light chain); optimal inter-stimulus interval; Tillin & Bishop (2009); коли PAP доступний, коли ні; clinical-safety NOT REQUIRED
