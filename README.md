...
│   ├── post-510: Як тренуватись при нестабільному сні — алгоритм, не самопочуття
│   ├── post-511: Різниця між «важко» і «продуктивно» — внутрішнє відчуття зусилля vs реальний стимул
│   ├── post-512: Ізоляційні вправи — коли вони справді потрібні, а коли це театр
