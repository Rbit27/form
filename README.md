...
│   ├── post-513: Чому план на 6 тижнів рідко доживає до кінця — і як це виправити
│   ├── post-514: Ексцентрична фаза — чому більшість людей її ігнорують і що вони втрачають
│   ├── post-515: Тренування при хронічному стресі — як коригувати об'єм коли нервова система перевантажена
│   ├── post-516: Суперсети — коли вони прискорюють прогрес, а коли саботують відновлення
│   └── post-517: Початківець vs проміжний — як зрозуміти що ти перейшов межу і що з цим робити
│   │
