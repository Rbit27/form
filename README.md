...
- [ ] post-97: Loaded carries — farmer's walk, yoke, suitcase carry: механізм gripstrength+core+gait, чому переносне навантаження будує те, чого не будує штанга; практичні протоколи і місце у тижні
