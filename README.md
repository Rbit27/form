...
- [ ] post-585: Мотиваційний клімат і автономія у тренуванні — Deci & Ryan (1985) SDT; autonomy-supportive vs controlling climate; Ntoumanis (2001) мотиваційний клімат у спорті; інтроєктована vs ідентифікована регуляція; clinical-safety NOT REQUIRED
...
- [ ] post-585: Психологія ваги на штанзі — систематичне недо- і перевантаження; fear of failure vs fear of success; Atkinson (1957) achievement motivation; практичний алгоритм калібрування RIR-якоря; clinical-safety NOT REQUIRED
- [ ] post-586: Уявний тренінг (mental rehearsal) і силове тренування — Driskell et al. (1994) meta-analysis; Feltz & Landers (1983); обмеження і реальний потенціал для аматора; clinical-safety NOT REQUIRED
