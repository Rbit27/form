...
- [ ] post-217: Архітектура м'яза і функція — пеннація, довжина волокна, фізіологічний поперечний переріз; чому «великий м'яз» і «сильний м'яз» не синоніми; Lieber & Fridén (2000 Muscle Nerve) архітектурні трейдофи; клінічне значення для вибору вправ і гіпертрофійного тренінгу; clinical-safety NOT REQUIRED
- [ ] post-218: Центральна команда і exercise pressor reflex — Krogh & Lindhard (1913) концепція центральної команди; Mitchell et al. (1983 J Physiol) ерготерапевтичний рефлекс і кардіоваскулярна відповідь; mechano- і metaboreceptors групи III/IV; чому ЦНС-втома і метаболічна втома — різні обмежувачі; clinical-safety NOT REQUIRED
- [ ] post-219: Rest-pause і myo-rep механіка — Hostler et al. (2001) та Prestes et al. (2017): rest-pause vs традиційні підходи при рівному об'ємі; механізм: підтримка близькості до відмови через короткі паузи; Myo-reps (Børge Fagerli): емпіричний протокол і теоретичне обґрунтування; коли щільність сетів переважає над традиційним об'ємом; clinical-safety NOT REQUIRED
