...
- [ ] post-153: Теломери і тренінг як геропротекція — hTERT і ерозія теломер; Cherkas et al. (2008 Arch Intern Med): близнюки і фізична активність; Werner et al. (2009 Circulation): тренінг → ↑ hTERT; LaRocca et al. (2010 J Physiol): аеробний тренінг і теломери ендотелію; IGF-1/FOXO3; межі: «більше тренінгу» не завжди краще; clinical-safety NOT REQUIRED
- [ ] post-154: Колаген і ECM — як тренінг зміцнює позаклітинний матрикс — тип I/III колагену, LOX кросслінкінг; Kjaer et al. (2009 Scand J Med Sci Sports): ↑ колагеновий синтез у сухожиллі при тренінгу; внутрішньом'язовий ECM і передача сили через перимізій; вікова колагенова дегенерація і протоколи для ECM; clinical-safety NOT REQUIRED
