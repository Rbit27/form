...
- [ ] post-46: Гормони і тренінг — тестостерон, кортизол, GH: що реально вимірюване і що є маркетинговим шумом
- [ ] post-47: Пропріоцепція і баланс у силовому тренінгу — навіщо це intermediate-атлету і як тренувати осмислено
- [ ] post-48: Адаптація до тренувального об'єму — хвиляста надорганізація, ступінчасте навантаження і точка «достатньо»
