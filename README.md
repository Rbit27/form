...
│   ├── post-499: Хронічна перевтома vs детренованість — де межа між «тренуюсь з дефіцитом» і «не тренуюсь взагалі»
│   ├── post-500: Навантаження на зв'язково-суглобовий апарат — чому болять суглоби, а не м'язи, і що з цим робити
