...
- [ ] post-213: Тренування і імунна функція — open window hypothesis після інтенсивного тренінгу (Gleeson 2007); J-curve залежність між обсягом і захворюваністю (Nieman 1994); ІЛ-6 як міокін і ранній медіатор запалення; практичні рішення: коли тренуватись при легкому нездужанні, коли ні; clinical-safety required (можуть стосуватись клінічних симптомів — лімітовано для тренувального контексту)
- [ ] post-214: Сила і когнітивні функції — Northey et al. (2018 BJSM) мета-аналіз: resistance training → MMSE/cognitive composite ES 0.66; BDNF і гіпокамп (van Praag 2008); prefrontal cortex і IGF-1 (Trejo 2001); HIIT vs силовий тренінг: різні когнітивні домени; практичне: аргумент «тренуюсь не тільки заради м'язів»; clinical-safety NOT REQUIRED
- [ ] post-215: Специфічність vs варіативність — SAID principle і практичний парадокс: чому тренувати все = не тренувати нічого конкретно; transfer of training дослідження (Barnett et al. 2002); вузька специфічність при збереженні загального фітнесу; блокова логіка як компроміс; clinical-safety NOT REQUIRED
