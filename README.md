...
- [ ] post-483: Перший рік тренувань — ретроспективний аналіз типових помилок і що реально має значення в перші 12 місяців
- [ ] post-484: Програмування для батьків — тренування при хронічному недосипанні після народження дитини; sleep-deprived training адаптація; Fullagar et al. (2015) сон і спортивні показники
