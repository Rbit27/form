...
- [x] post-580: Дисоціативна vs асоціативна увага у довгих підходах — Morgan et al. (1987) класичний elite/recreational split; Stevinson & Biddle (1998) перевірка у силовому тренінгу; Brick et al. (2016) чотиривимірна таксономія і тактичне переключення; Wulf (2013) зовнішній фокус vs внутрішній; Terry et al. (2020) музика як дисоціативний модулятор; протокол структурованої уваги per-set; clinical-safety NOT REQUIRED · authored v4.14.0
    ── ROADMAP (наступні теми · post-581+) ───────────────────────────
- [ ] post-581: Контрфактуальне мислення і тренувальний прогрес — Roese (1997) Psychol Bull функції counterfactual thinking; upward vs downward counterfactuals; як «якби я тренувався по-іншому» мислення впливає на планування і post-failure response; clinical-safety NOT REQUIRED
- [ ] post-582: Емоційна регуляція і тренувальна поведінка — Gross (1998) process model ER; cognitive reappraisal vs expressive suppression у спортивному контексті; Baumeister et al. і emotion regulation depletion; Totterdell & Leach (2001) mood regulation in sport; як техніки ER впливають на RIR-оцінку і prematurely stopping set; clinical-safety NOT REQUIRED
- [ ] post-583: Психологія «добрих тренувань» і «поганих тренувань» — чому суб'єктивна оцінка якості тренування систематично хибна; Ekkekakis et al. (2011) affect-based models; Hardy & Rejeski (1989) feeling states у фізичній активності; як RPE і внутрішній стан не корелюють з об'єктивним стимулом; практичний 3-питання post-set check; clinical-safety NOT REQUIRED
