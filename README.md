...
│   ├── post-501: Вибір між програмою і принципами — коли слідувати шаблону, а коли розуміти механіку
│   ├── post-502: Функціональна сила — що це реально означає, де хайп і де доказова база
│   └── post-503: Прогресія новачка: типові помилки першого року, які затримують розвиток на роки
│   │
