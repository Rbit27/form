...
**Status:** v0.8.0 · pre-launch · Closed Beta planning Q3 2026 · Київ
...
- **37+ markdown documents** — strategic, operational, content
...
│
├── VERSION                 ← single source of truth (0.8.0)
