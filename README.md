...
- [ ] post-448: Тренування у подорожі — Issurin (2008) residual effects і детренованість; мінімальний протокол за 30 хвилин без обладнання; чому «надолужувати» після відрядження — помилка програмування; clinical-safety NOT REQUIRED
