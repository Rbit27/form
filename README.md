...
- [ ] post-49: Пропріоцепція і баланс у силовому тренінгу — навіщо це intermediate-атлету і як тренувати осмислено
- [ ] post-50: Програмування для занятого: MEV-режим, 3-денний повний тиждень і як не втрачати результат при нестабільному розкладі
