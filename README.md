...
- [ ] post-451: Тренування у подорожі — Issurin (2008) residual effects і детренованість; мінімальний протокол за 30 хвилин без обладнання; чому «надолужувати» після відрядження — помилка програмування; clinical-safety NOT REQUIRED
- [ ] post-449: Психологія зупинки підходу — де фізіологічна відмова і де психологічна зупинка; Marcora et al. (2009) perceived effort і центральна регуляція зусилля; self-talk і RIR-anchor; що роблять добре калібрований атлет vs погано калібрований; clinical-safety NOT REQUIRED
- [ ] post-450: Силовий тренінг і імунна система — чи «пригнічує» інтенсивний тренінг імунітет; J-curve hypothesis Nieman (1994); відкрите вікно і реальний ризик; де знаходиться пороговий об'єм/інтенсивність; practical guidelines; clinical-safety NOT REQUIRED
