...
- [x] post-579: Соціальне порівняння у залі — Festinger (1954) social comparison theory; Suls & Wheeler (2000) upward/downward/lateral; Buunk & Gibbons (2007) sport context; White et al. (2009) perceived attainability mediator; Martin Ginis et al. (2008) gym mirrors + attention; journal як internal baseline; clinical-safety NOT REQUIRED · authored v4.13.0
    ── ROADMAP (наступні теми · post-580+) ───────────────────────────
- [ ] post-580: Дисоціативна vs асоціативна увага у довгих підходах — Morgan et al. (1987) класичний elite/recreational split; Stevinson & Biddle (1998) перевірка у силовому тренінгу; Brick et al. (2016) tactical use of attentional strategies; коли dissociation знижує якість техніки vs коли допомагає подолати монотонний об'єм; clinical-safety NOT REQUIRED
