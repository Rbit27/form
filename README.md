...
│   ├── [ ] post-519: Пропущені тренування — одна сесія, тиждень, місяць: що реально втрачається і як повернутись
│   ├── [ ] post-520: Тренування двічі на день — коли це має сенс для аматора і коли це самознищення
