...
- [ ] post-118: Відпочинок між підходами і гіпертрофія — Schoenfeld et al. (2016) JSCR: 3 хв vs 1 хв між сетами, 67% більше гіпертрофія при 3 хв; механізм: часткове відновлення PCr і буферизація метаболітів; Ahtiainen et al. (2005) гормональна відповідь; де короткий відпочинок виправданий і де шкодить; clinical-safety: not required
- [ ] post-119: Drop sets і механічні дроп-сети — теорія (обсяг при втомі), Schoenfeld et al. (2018) drop vs straight sets для гіпертрофії; коли дроп-сет є ефективним методом і коли це просто маркетинг; mechanical drop set vs weight reduction drop set; clinical-safety: not required
- [ ] post-120: Міофібрилярна vs саркоплазматична гіпертрофія — чи існує ця відмінність? Schoenfeld критика (2010), Haun et al. (2019) PLOS ONE: glygogen і sarcoplasmic protein зростання при high-rep; що реально доведено, що є гіпотезою; практичні наслідки (якщо вони є); clinical-safety: not required
- [ ] post-121: Додавання саркомерів і адаптація довжини м'яза — Lynn & Morgan (1994) sarcomerogenesis; ексцентричний тренінг → збільшення оптимального кута; Nordic Hamstring і довжина фасцикул (Mjøsund 2021); чому довжина м'яза при піковій силі змінюється з тренінгом; clinical-safety: not required
- [ ] post-122: Кут пір'їстості (pennation angle) і сила — адаптація θ при гіпертрофії (Kawakami 1993); компроміс між силою і швидкістю на рівні архітектури; чому газтрокнемій важко гіпертрофується; PCSA і ізометрична сила; clinical-safety: not required
