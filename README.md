...
│   ├── post-412: Серійний початківець — фізіологія і психологія повторних стартів
│   ├── post-413: Прогрес без відчуття прогресу — коли адаптація є, а суб'єктивно «нічого не змінилось»
│   ├── post-414: Кінець тренувального блоку — критерії завершення мезоциклу і перехід до нового
│   └── post-415: Не чіпай, поки росте — чому відмова від оптимізації у фазі зростання — це стратегія
│   │
