...
- [ ] post-46: Пропріоцепція і баланс у силовому тренінгу — навіщо це intermediate-атлету і як тренувати осмислено
- [ ] post-47: Адаптація до тренувального об'єму — хвиляста надорганізація, ступінчасте навантаження і точка «достатньо»
