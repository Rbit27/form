...
- [ ] post-347: Аеробна база і силовий тренінг — чому «кардіо вбиває м'язи» — застарілий міф; Zone 2 як база VO2max, вплив аеробної ємності на відновлення між підходами і сесіями, практична інтеграція без interference; clinical-safety NOT REQUIRED
...
- [ ] post-350: Самостійне ведення тренувального журналу — RPE-трекінг, 4 ключових параметри на підхід, розпізнавання стагнації vs плато; без додатків, лише папір або нотатник
