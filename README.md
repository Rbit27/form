...
- [ ] post-445: Деренування і повернення до тренувань — Bickel et al. (2011) 1/9 об'єму зберігає адаптації 32 тижні; Issurin (2008) резидуальні ефекти 25–35 днів; чому перший тиждень після перерви ≠ надолуження; матриця рішень за тривалістю перерви
- [ ] post-446: Дроп-сети механіка і застосування — Fink et al. (2018) дроп-сети і традиційні підходи: гіпертрофія при еквівалентному часі; три механізми (метаболічний стрес, M-U recruitment при втомі, клітинне набрякання); операційний алгоритм зниження ваги; для яких вправ підходять і де шкодять; clinical-safety NOT REQUIRED
- [ ] post-447: Конкурентне тренування і практик — як поєднати силу і кардіо без interference при нестачі часу; практичне програмування для аматора; Wilson et al. (2012) мета-аналіз; interference effect при різних режимах; clinical-safety NOT REQUIRED
