...
│   ├── post-384: Гормон росту в контексті тренінгу — фізіологія без маркетингових міфів
│   ├── post-385: Ефективність vs ефектність у тренуванні — чому той самий результат досягається з меншим об'ємом
