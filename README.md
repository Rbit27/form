...
- [ ] post-226: Варіативність vs специфічність — чому program hopping вбиває прогрес; мінімальний горизонт для вимірюваної структурної адаптації (6–12 тижнів); SAID і адаптаційна специфічність; коли варіювати вправи є методом, а коли — уникненням слабкого місця; clinical-safety NOT REQUIRED
- [ ] post-227: RPE calibration для self-coached атлетів — чому суб'єктивне сприйняття навантаження ненадійне без калібрування; Borg RPE vs Zourdos mRPE; три методи верифікації RPE через об'єктивні маркери; поширені помилки calibration у intermediate; clinical-safety NOT REQUIRED
