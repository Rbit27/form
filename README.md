...
- [ ] post-352: Програмування після повернення з тривалої паузи — розрізнення детренованості м'язової vs нейральної, Bickel (2011) maintenance MED, Seaborne (2018) міонуклеарна пам'ять; як не «надолужувати» і не отримати DOMS-травму; clinical-safety NOT REQUIRED
- [ ] post-353: Тренування при хронічній недосипанні — Knowles et al. механізм; що знижується першим (максимальна сила, мотивація, сприйняття зусилля); мінімальний протокол для підтримки адаптації; clinical-safety NOT REQUIRED
- [ ] post-354: Силовий тренінг і мобільність — чому «розтяжка після тренування» не будує мобільність і що насправді змінює функціональний діапазон; тренінг в крайніх точках амплітуди як самодостатній інструмент; clinical-safety NOT REQUIRED
- [ ] post-355: Ізометричний тренінг як доповнення — overcoming vs yielding ізометрія, кутова специфічність, роль у реабілітаційному переході; clinical-safety NOT REQUIRED
