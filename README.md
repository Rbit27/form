...
- [ ] post-139: Reactive oxygen species (ROS) і гормезис у тренінгу — мітохондріальний ROS як сигнальна молекула (не лише пошкоджуючий агент); NRF2 activation і антиоксидантний відгук; Ristow et al. (2009 PNAS) — антиоксиданти блокують адаптацію у людей; Gomez-Cabrera et al. (2008); парадокс суплементації вітамінами C/E при силовому тренінгу; hormesis як тренувальний принцип; clinical-safety NOT REQUIRED
- [ ] post-140: Аутофагія і тренінг — якість контролю клітини через мітофагію і протеасому; AMPK-індукована аутофагія (AMPK→ULK1); mTOR-аутофагія toggle: чому вони не активні одночасно; Jamart et al. (2012) — тренінг активує аутофагію в м'язі; роль у ремоделюванні при силовому тренінгу; practical window для тренінгу і відновлення; clinical-safety NOT REQUIRED
- [ ] post-141: Механотрансдукція і tensegrity — як механічний стрес передається від міофібрили до ядра; integrin–costamere–cytoskeleton–LINC complex–nuclear lamina ланцюг; mechanosensitive ion channels (Piezo1/2); focal adhesion kinase (FAK) і ранній сигнальний відгук (Flück et al. 2008); tensegrity як клітинна архітектурна модель (Ingber 2003); phosphatidic acid synthesis through PLD (Hornberger revisited); clinical-safety NOT REQUIRED
- [ ] post-142: Рибосомна біогенез і тренувальний об'єм — рибосомна ємність як пляшкове горло синтезу білка (Figueiredo et al. 2015, 2017); rDNA транскрипція через c-Myc і mTORC1/S6K1 → Pol I; 4–8 тижнів тренінгу збільшують рибосомний вміст м'яза; volume loading як тригер биогенезу рибосом; пояснення, чому new/untrained атлети реагують швидше при мінімальному об'ємі; practical: нарощування об'єму не лише для механічного стимулу — але й для збільшення трансляційної потужності; clinical-safety NOT REQUIRED
