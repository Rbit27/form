...
│   ├── post-505: Функціональна сила — що це реально означає, де хайп і де доказова база
│   ├── post-506: Адаптаційне відставання — чому результати тренування приходять із запізненням і як це використовувати
│   ├── post-507: Тренування і кортизол — коли хронічний стрес зупиняє адаптацію (і коли ні)
│   └── post-508: Самопрограмування з нуля — мета-гайд для людини без тренера
│   │
...
- [ ] post-505: Функціональна сила — що це реально означає, де хайп і де доказова база. clinical-safety NOT REQUIRED
- [ ] post-506: Адаптаційне відставання — чому результати тренування приходять із запізненням і як це використовувати. clinical-safety NOT REQUIRED
- [ ] post-507: Тренування і кортизол — коли хронічний стрес зупиняє адаптацію (і коли ні). clinical-safety NOT REQUIRED
