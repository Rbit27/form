...
| Control ID | Control | Implementation | Status | Evidence |
|---|---|---|---|---|
| **PRV-23** | Retention schedule published in privacy policy with per-category periods | Retention tiers defined in `docs/AUDIT_LOG_SCHEMA.md`; per-category periods decided in `compliance/p1/retention-decisions.md` (P1-RET-001, effective 2026-05-21) — pending publication in privacy policy | 🟡 Authored — P-GAP-004 | `compliance/p1/retention-decisions.md` (P1-RET-001); §35.6.3 retention schedule |
...
| **PRV-26** | Supabase TTL policies for active-coaching tables: formal decision record required before privacy policy publication | Per-category decisions recorded in `compliance/p1/retention-decisions.md` (P1-RET-001, effective 2026-05-21); Supabase TTL migrations and privacy policy publication still pending | 🟡 Authored — P-GAP-004 | `compliance/p1/retention-decisions.md` (P1-RET-001, authored 2026-05-21) |
...
| **PRV-52** | Formal privacy complaint intake — `privacy@form.coach` mailbox; documented 30-day response SLA per GDPR Art. 77; complaint log in `compliance/p1/complaint-log.csv` | Procedure authored at `compliance/p1/complaint-intake-procedure.md` (P1-CIP-001, effective 2026-05-21); complaint-log.csv seeded; pending: `privacy@form.coach` mailbox creation, privacy policy publication | 🟡 Authored — P-GAP-007 | `compliance/p1/complaint-intake-procedure.md` (P1-CIP-001); mailbox creation pending |
...
| **P-GAP-004** | P1 | P1.1, P4.2 | Workout/health data retention periods not formally decided or stated in privacy policy — `cv_sessions`, `wearable_readings`, `workout_sessions`, `coaching_turns` all TBD (§35.6.3 proposed periods); auditors require explicit per-category schedule in user-facing policy | ✅ Retention decision record authored at `compliance/p1/retention-decisions.md` (P1-RET-001, effective 2026-05-21) using §35.6.3 proposed periods. **Remaining:** legal sign-off; add retention table to privacy policy (blocked on P-GAP-001); implement Supabase TTL migrations | `compliance-officer` + `engineering` | Pre-launch |
...
| **P-GAP-007** | P1 | P8.1 | No formal privacy complaint intake process; no `privacy@form.coach` mailbox published; no 30-day response SLA — data subjects have no published channel for Art. 15–22 requests outside the in-app DSAR flow | ✅ Procedure drafted at `compliance/p1/complaint-intake-procedure.md` (P1-CIP-001, effective 2026-05-21) with 30-day SLA, Art. 77 supervisory authority escalation, complaint-log.csv. **Remaining:** create `privacy@form.coach` mailbox; add privacy contact to privacy policy and Settings (blocked on P-GAP-001) | `compliance-officer` | Pre-launch |
...
| **P-GAP-004** | P | §35 | Retention periods for `cv_sessions`, `wearable_readings`, `workout_sessions`, `coaching_turns` not formally decided or published. | compliance-officer + engineering | P1 | Pre-launch | 🟡 Authored — `compliance/p1/retention-decisions.md` (P1-RET-001, 2026-05-21); pending legal sign-off + privacy policy publication |
...
| **P-GAP-007** | P | §35 | No `privacy@form.coach` mailbox; no formal complaint intake procedure; no 30-day response SLA published. | compliance-officer | P1 | Pre-launch | 🟡 Authored — `compliance/p1/complaint-intake-procedure.md` (P1-CIP-001, 2026-05-21); pending mailbox creation + privacy policy publication |
...
| **Policies** | Sub-processor register (internal) | `compliance/p1/sub-processor-register.md` | compliance-officer | 🟡 Authored (P1-SUB-001, 2026-05-21) — Sentry DPA in progress; publication to `form.coach/legal/sub-processors` still required (P-GAP-002) |
...
├── p1/
│   ├── complaint-intake-procedure.md     (P-GAP-007) ✅ authored 2026-05-21
│   ├── complaint-log.csv                 ✅ seeded
│   ├── dsar-export-schema.json           🔴 to create
│   ├── gov-request-policy.md             (P-GAP-006) 🔴 to create
│   ├── privacy-policy-changelog.md       🔴 to create
│   ├── retention-decisions.md            (P-GAP-004) ✅ authored 2026-05-21
│   └── sub-processor-register.md         (P-GAP-002 partial) ✅ authored 2026-05-21
└── pentests/<YYYY-MM-DD>/
