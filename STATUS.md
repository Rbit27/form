...
| 1001–1050 | Training literacy: reading your own data | 10/50 | **IN PROGRESS v5.49.0** — post-1001 «Від запису до читання» (PASS). **posts 1002–1005 v5.49.0:** особистий «норм» і базова лінія (PASS); трендова лінія vs. точка (PASS); помилки інтерпретації прогресу (PASS); RPE як дані — калібрування суб'єктивної шкали (PASS). **posts 1006–1010 v5.49.0:** ЧСС і HRV (RMSSD, PPG vs. ECG, 7–14d trend · PASS); сон як тренувальна змінна (SWS/GH, 1ПМ drop · PASS); «енергія на тренуванні» (arousal vs. readiness · PASS); реальна vs. тимчасова адаптація (3-tier model · PASS); плато — діагностика vs. нормальний процес (4 умови + таблиця рішень · PASS). blog.html updated to post-1010. sports-scientist review required before publish. |

**Total posts: 1001** (includes posts 1001–1010; post-980 HARD VETO skipped)
...
- Block 1001–1050: **IN PROGRESS 10/50 · v5.49.0** — posts 1001–1010 written (перший кластер повністю). Next: 1011–1020 (individual calibration topics: n-of-1, feedback loop, self-diagnosis errors, when to get external help, long-term trends). sports-scientist review required before publish.
