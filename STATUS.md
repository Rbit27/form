...
- Block 1051–1100: **IN PROGRESS 40/50 · v5.78.0** — тема: М'язова специфіка та функціональна анатомія. Cluster 1–7 COMPLETE (posts 1051–1085). Cluster 8 (posts 1086–1090) **COMPLETE v5.78.0**: dorsal interossei (1086), palmar interossei (1087), thenar complex APB/OP/FPB (1088), hypothenar complex ADM/FDMB/ODM (1089), adductor pollicis + Froment's sign (1090). blog.html updated to post-1090. sports-scientist review required before publish. Наступний: posts 1091–1095 (extensor indicis proprius, extensor digiti minimi, extensor digitorum communis architecture, sagittal band, retinacular system of digits).
