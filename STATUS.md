...
| 651–700 | Biomechanics & injury prevention | 5 | In progress — posts 651–655 written; sports-scientist review required before publish |
...
- Block 651–700: posts 651–655 written (kinetic chain, mobility/stability framework, ankle mobility, squat anatomy, bench press biomechanics). Next: posts 656–660 — deadlift mechanics, core stability, breathing patterns, shoulder complex (659 — clinical-safety review required before writing), rehab-to-performance (660 — clinical-safety review required before writing)
...
**v0.1 · червень 2026 · process-keeper · update every iteration · v4.59.0**
