...
- Block 1001–1050: **IN PROGRESS 11/50 · v5.50.0** — posts 1001–1010 written (перший кластер повністю). post-1011 written: технічний дрейф під втомою (3 системи без відео: фіксовані точки контролю, темпова проксі, роздільний RPE-техніки / RPE-зусилля). clinical-safety: NOT_REQUIRED. Next: 1012–1020. sports-scientist review required before publish.
