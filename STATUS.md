...
| [`blog.html`](blog.html) | Articles index — 460 cards (554 posts authored), category filter, newsletter CTA | v4.4.0 ✓ |
...
**v4.7.0 · 12 червня 2026**
**Last update:** 12 червня 2026 · v4.7.0 (posts 559–562 · «дрімота перед тренуванням» · «готовність у перший день тижня» · «холодний душ і гіпертрофія» · «самовербалізація і сила» · clinical-safety NOT REQUIRED · blog.html +4 cards · roadmap post-563+ залишається)
