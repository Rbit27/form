...
| 801–850 | Evidence-based deep dives | 36 | **36/50 written** — posts 801–810: creatine, protein, caffeine, periodization vs. autoregulation, RPE/RIR, hypertrophy mechanisms, myofibrillar vs. sarcoplasmic, steroids/research interpretation, genetic ceiling, fat as endocrine organ. Posts 811–820: sleep & performance, deload science, training age, volume landmarks (MEV/MAV/MRV), inter-set rest, rate of force development, concurrent training interference, heat/cold exposure, altitude training, evidence-based stretching. Posts 821–830 (v5.8.0): protein timing, creatine loading revisited, beta-alanine, citrulline/nitrates, magnesium, omega-3 + training, Vitamin D + athletes, ashwagandha (CONDITIONAL PASS), sleep supplements melatonin/glycine (CONDITIONAL PASS), CBD & recovery (CONDITIONAL PASS). **Post 831 (v5.8.1):** antioxidants & training adaptation paradox — ROS signaling, AMPK/PGC-1α, Gomez-Cabrera 2008, Ristow 2009, Paulsen 2014; clinical-safety: PASS. **Post 832 (v5.9.0):** HMB evidence review — UPS/MAFbx/MuRF-1 mechanism, Nissen 1996 conflict-of-interest analysis, Jakubowski 2020 independent RCT (no effect), sponsor-bias pattern; clinical-safety: PASS. **Post 833 (v5.9.0):** caffeine tolerance and cycling — adenosine A₁/A₂A upregulation mechanism, Bell & McLellan 2002, Grgic 2020 meta-analysis, wash-out strategy, selective-use strategy, CYP1A2 variability, L-theanine combination; clinical-safety: PASS. **Post 834 (v5.10.0):** glutamine evidence review — ендогенний синтез, Antonio & Street 1999, Candow 2001, Legault 2015 (null results у тренованих), Gleeson 2008 (імунітет: слабкі дані), клінічний контекст (сепсис/хірургія) vs. спортивний маркетинг, leaky gut myth; clinical-safety: PASS. Blog cards added for posts 832, 833, 834. **Post 835 (v5.11.0):** ZMA (zinc + magnesium aspartate + B6) — Brilla & Conte 2000 conflict-of-interest analysis (BALCO founder as patent holder and study author), King 2003 + Wilborn 2004 independent null replications, zinc-testosterone link in deficiency context (Hamalainen 1984/1985), magnesium and sleep (Abbasi 2012 — deficient elderly; no effect in replete athletes), patented form no absorption advantage; clinical-safety: PASS. **Post 836 (v5.11.0):** collagen peptides — Shaw 2017 (AJCN, gelatin + vitamin C 15 g pre-exercise → 50% increase engineered-ligament collagen synthesis, surrogate endpoint), Dressler 2018 (Nutrients, 5 g/day + eccentric rehab: Achilles tendinopathy VISA-A +26 vs. +15, functional RCT), Clark 2008 (joint pain, 10 g/day, 24 wk), prolyl hydroxylase vitamin C cofactor mechanism, 30–60 min pre-exercise timing rationale; who benefits (tendon rehab, masters 40+, symptomatic joint pain) vs. who does not (healthy young athletes seeking muscle); clinical-safety: CONDITIONAL PASS (embedded guard rail for chronic joint pain). **Next:** posts 837–840 (sodium bicarbonate buffering, nitrate timing, adaptogen comparison, rhodiola rosea). All sports-scientist review required before publish. |

**Total posts: 833**

**Editorial series 11–31** — post-31 written v5.11.1: «Мобільність або гнучкість — де та межа, яка важлива для силового атлета» — mobility vs flexibility distinction, structural/tissue/neuromuscular constraint taxonomy, static stretching pre-lift evidence (Behm & Chaouachi 2011), dynamic warmup rationale, practical squat/deadlift/overhead assessment criteria; clinical-safety: PASS. Blog card added. Roadmap extended to posts 36–40. Proposed next: posts 32–35 (reading research, self-programming vs coach, dropout mechanics, breathing mechanics). Open question: OQ-EDITORIAL-01 — filename collision with May 2026 short posts (post-22-periodization.md etc.) — status: 🟡 Unresolved.
