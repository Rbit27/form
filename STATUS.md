...
- Block 1051–1100: **IN PROGRESS 41/50 · v5.80.0** — тема: М'язова специфіка та функціональна анатомія. Cluster 1–8 COMPLETE (posts 1051–1090). Cluster 9 (posts 1091–1095) IN PROGRESS: **post-1091 DONE v5.80.0** — extensor indicis proprius (PIN innervation, pointing sign, EIP→EPL tendon transfer). blog.html updated to post-1091. sports-scientist review required before publish. Наступний: posts 1092–1095 (extensor digiti minimi, extensor digitorum communis architecture, sagittal band, retinacular system of digits).
