...
**Total posts: 1071** (includes posts 1001–1070, post-106, post-107, post-108; post-980 and post-639 HARD VETO skipped)

**Editorial series 11–34, 44–50, 106–108** — post-50 written v5.61.0: «Синтез: як FORM думає про рішення за замовчуванням для self-coached атлета». post-106 written v5.63.0: «Чому тижневий мікроцикл важливіший за тренувальну сесію» — мікроцикл як функціональна одиниця, ATL/CTL спрощена логіка, тижневий обсяг і частота, практичний алгоритм тижневої діагностики. **post-107 written v5.65.0:** «Як відрізнити «поганий день» від «поганого блоку» — алгоритм без паніки» — горизонт як єдиний інструмент, RPE-тренд, HRV rolling average, суб'єктивний аудит, алгоритм 4 кроки. clinical-safety: PASS. Blog card added. README roadmap розширено: теми 106–111 додано. **post-108 written v5.67.0:** «Тренування і когнітивна продуктивність — що спортивна наука реально показує» — гострий ефект аеробного навантаження (Lambourne & Tomporowski 2010), BDNF і хронічний ефект (Erickson 2011), перевернута J-крива overtrained стан, тайминг ранок vs. вечір, силове тренування і когніція (Liu-Ambrose 2010), сон як медіатор. clinical-safety: PASS. Blog card added. Open question: OQ-EDITORIAL-01 — filename collision with May 2026 short posts — status: 🟡 Unresolved.
